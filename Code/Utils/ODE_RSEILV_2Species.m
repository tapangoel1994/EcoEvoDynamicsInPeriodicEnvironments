...
% Modified from JDH's SEnIV code for the latent period project.
%% 
%%Author: Tapan Goel
...
dydt(5:6) = (1-reshape(params.q,[1,2])).*params.lambda.*E - params.eta*I + reshape(params.gamma,[1,2]).*L - params.d_I*I; %% dI/dt
