...
params.d_S = .2; %per hour %death rate of susceptible cells
params.d_E = .2; %per hour %death rate of exposed cells
params.d_L = .2; %per hour %death rate of lysogens
params.d_I = .2; %per hour %death rate of lytically infected cells
...
PGamma = struct('lytic',[0 0],'temperate',[.5 .083],'lysogenic',[1 0]); %temperate strategy is optimal for T = 24hr, q_L = 0.2, q_V = 0
