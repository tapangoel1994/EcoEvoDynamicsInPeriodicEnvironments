...
%% this code generates figure S12
...
V02 = 10*criticaldensitythreshold;
...
x0 = x0 + [0 0 0 q_E*Vb_0 0 q_I*V02 0 q_L*V02 0 q_V*V02]./q_Total;
...
%% Plot cycle-to-cycle dynamics
   ...
   %% Save Figure
   saveas(fig,'../RevisedFigures/FigureS12.svg');%save as svg
