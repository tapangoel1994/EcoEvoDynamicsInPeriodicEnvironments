%% This script generates data for Figures S10 and S11 for the revised manuscript.
...
CyclePeriodList = [4, 8, 12, 16, 20, 24, 36, 48, 96]; %list of growth cycle periods in hours

q_LV = [0.025 0;0.05 0;0.1 0;0.2 0;0.4 0;...
        0 0.05;0 0.1;0 0.2];  % each row contains the q_L and q_V values for each filtration condition
...
%% Load or generate invasion matrices using utils\InvasionDynamics
