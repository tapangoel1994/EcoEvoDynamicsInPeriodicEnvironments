%% SI for figure S5 to compare total steady state viral genome densities across filtration conditions and strategies
%% Generates figure S9 

%% Date created: 1/31/2025
%% Author: Tapan Goel

close all; 
clear all;

%% load fixed paraemeters and color scheme
addpath('utils/');
addpath('lib/');
    colorpalette;
...
%% Save Figure;
saveas(h,'../RevisedFigures/FigureS9.svg');       
