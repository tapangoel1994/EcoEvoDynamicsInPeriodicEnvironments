%% This script generates Figure 5 for the revised manuscript.
...
nexttile(5);
    ...
    plot(OptimalStrategy(OptimalStrategy.q_L == .2 & OptimalStrategy.q_V == 0 & OptimalStrategy.CyclePeriod == 48,:).CyclePeriod, ...
        OptimalStrategy(OptimalStrategy.q_L == .2 & OptimalStrategy.q_V == 0 & OptimalStrategy.CyclePeriod == 48,:).pESS, ...
    ...
    set(gca,'XTick',0:12:96,'XTickLabel',0:12:96,'YLim',[0 1],'YTick',0:.1:1,'FontSize',14,'FontWeight','bold','TickLabelInterpreter','latex','Box','off', 'YMinorTick','off');
    xlabel('Cycle period (hr)','FontSize',16,'Interpreter','latex','FontWeight','bold');
...
%% Save figure
saveas(h,'../RevisedFigures/Figure5.svg');